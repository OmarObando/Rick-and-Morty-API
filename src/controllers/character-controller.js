...
//We are going to use the helpers folder to manage the data, this is a good practice to separate the data from the logic
//We can mantain the code more easily and we can use the helpers in other parts of the code
//In anoter scenario, we could add helpers to manage the data directly from the service, but in this case we are going to use the helpers to manage the data from the controller
